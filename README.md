...
배경원화와 게임 기획 경험을 바탕으로 Unity 기반 플레이어블 프로토타입을 제작하는 다재다능한 게임 개발자
...
- **Hero 섹션**: Unity Gameplay/Client 포지션, 핵심 소개 문구, 대표 프로젝트·Notion 이력서 CTA
- **About 섹션**: 자기소개, 강점 4가지 카드(Scene/Prefab 개발, 아트+기획+구현, Enemy AI, 검증 가능한 기록), 기술 스택 태그
- **Game Development 섹션**: Hero 바로 다음에 대표작 3개를 우선 노출하고,
  구성·엔진·플랫폼·상태 메타와 역할/문제-판단/구현/검증 구조로 상세 소개
- 프로젝트 표지에서 게임플레이 영상 또는 Web Playtest로 바로 진입하고,
  GitHub·빌드·발표자료·문서 링크를 함께 제공
...
playtests/star-vanguard-map1/
                        Star Vanguard Map 1 MVP13 Web Playtest 스냅샷
```
...
3. HorrorStealth 표지를 실제 플레이 화면이나 짧은 영상/GIF로 교체
4. 컬러 톤(현재 앰버&틸 다크 테마)에 대한 피드백 반영

## 배포

main 브랜치 루트가 GitHub Pages로 배포됩니다.
